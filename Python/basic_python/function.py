"""函数参数"""
# 必选参数、默认参数、可变参数、关键字参数、命名关键字参数(顺序不能变)
# 1 必选参数: 必须填
def power(a, b)
    pass
# 2 默认参数：可填可不填
...
# 例
def mainLoader(**params):
    feature_path = params.get("feature_path", "")
    label_path = params.get("label_path", "")

basic_data_params = {
    'feature_path': 'hdfs://hadoop-1:5000/training_new/first_havepay_feature',
    'label_path': 'hdfs://hadoop-1:5000/training_new/first_havepay_label_data',
}
data_loader = MainLoader(**basic_data_params)
